...
class VerificationFailed(LeanCertError):
    ...
    def __init__(
        self,
        message: str,
        computed_bound: Any | None = None,
        counterexample_box: Box | None = None,
    ):
...
class VerificationTimeout(LeanCertError):
    ...
    def __init__(self, message: str, elapsed_seconds: float, partial_result: Any | None = None):
        super().__init__(message)
...
class ProtocolViolation(BridgeError):
    """Raised when the bridge violates its advertised wire contract."""
...
class UnsupportedExpressionError(ExpressionError):
    ...
    def __init__(self, kind: str, context: str | None = None):
...
class PartialFunctionError(ExpressionError):
    ...
    def __init__(self, func_name: str, domain_info: str | None = None):
...
def _get_suggestion_for_kind(kind: str) -> str | None:
