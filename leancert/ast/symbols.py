...
def _name(value: str, label: str) -> str:
    if (
        ...
        or value.startswith("__leancert")
    ):
...
class Symbol(Node):
    ...
    def __post_init__(self):
        _name(self.display_name, "symbol name")
        _name(self.identifier.namespace, "namespace")
...
class SymbolTable:
    ...
    def var(self, name: str, sort: Sort = REAL):
        ...
        if key not in self._symbols:
            self._symbols[key] = Variable(Symbol(SymbolId(self.namespace, name), name, sort))
